...
//        loadBackupRestoreCollection();
        ...
        if (!ATMobileDataAccessAbstract.decimals_set)
            initDecimals();
   ...
   /* public void deleteInstance()
    ...
    private void initDecimals()
    {
        ...
        if (dfs.getDecimalSeparator()=='.')
            ATMobileDataAccessAbstract.false_decimal = ',';
        else
            ATMobileDataAccessAbstract.false_decimal = '.';
    ...
    {
        if (this.getLastParentType() == ATMobileDataAccessAbstract.PARENT_FRAME)
        {
...
*/
    ...
    public int getLastContainerType()
    {
        if ((cnt_list.get(cnt_list.size() - 1)) instanceof JFrame)
        {
            ...
            return ATMobileDataAccessAbstract.PARENT_DIALOG;
    }
...
/*
    ...
    public JButton createHelpButtonByBounds(int x, int y, int width,
            int height, Container comp)
    {
        ...
        help_button.setIcon(this.getImageIcon_22x22("help.png", comp));
        // help_button.setIcon(new ImageIcon(new
        // Image(getClass().getResource(getImagesRoot() + "/help.png"))).);
...
*/
    ...
    */
    ...
    public void centerJDialog(Component dialog, Component /*Container*/ parent)
    {
