...
//x                        foundDouble=true;
    ...
    public synchronized String getMessageFromCatalog(String msg)
    {
        ...
        try
        {
            ...
            if (ret==null)
            {
                System.out.println("Warn: I18nControl(" + this.selected_language +"): Couldn't find message: " + msg);
    ...
    public void createCollationDefintion()
    {
        ...
        else
        {
            ...
            catch(Exception ex)
            {
                ...
                System.out.println("Error: Exception creating collator: " + ex);
