...
public class UpdateDialog extends JDialog implements ActionListener, HelpCapable, ComponentHelpCapable
{
    ...
    public void cmdUpdate()
    {
        ...
        this.model = new UpdateSystemModel(this.update_config, dataAccess);
        ...
        UpdateTableCellRenderer utcr = new UpdateTableCellRenderer(dataAccess);
        ...
        this.btnNotes = ATSwingUtils.getButton("   " + i18nControl.getMessage("NOTES") + "...", 455, 90, 150, 25,
            panel, //
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            new UpdateNewsDialog(this, dataAccess);
        }
    ...
    public UpdateSystemModel getModel()
    {
        return this.model;
    }
