 ...
 *  
 *  DbImport - batch file importing into database
...
public class DbImport extends DbApplicationAbstract
{
     ...
     * @param osa
     */
    public DbImport(UpdateConfiguration uc, StartupOSAbstract osa)
    {
        super(uc, osa);
    }
