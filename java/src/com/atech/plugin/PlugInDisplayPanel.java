...
public class PlugInDisplayPanel extends JPanel
{
    ...
    public void init()
    {
        ...
        ATSwingUtils.getLabel(m_da.getI18nControlInstance().getMessage("PLUGIN_DISPLAY_NAME"), 
            10, 0, this.m_sett.getBounds().width-10, 30, this, ATSwingUtils.FONT_NORMAL_BOLD);
