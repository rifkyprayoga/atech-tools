...
public class IcePdfViewer
{
    ...
    public void open(String contentFile, String contentURL, String contentProperties, Properties properties)
    {
        ...
        applicationFrame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE); // .EXIT_ON_CLOSE);
         ...
         * windowManager = new WindowManager(propertiesManager,
         * activeLanguageBundle);
         ...
         * activeLanguageBundle.getString("viewer.launcher.URLError.dialog.title"
         * ), 1);
         * } else {
