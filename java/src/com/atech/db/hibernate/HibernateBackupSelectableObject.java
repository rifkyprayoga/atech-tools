...
public abstract class HibernateBackupSelectableObject extends HibernateBackupObject implements SelectableInterface
{
    ...
    // /**
    // * To String Descriptive. It shows a little bit of data about object (used for delete). So for
    // example
    // * you would description as something like that. DoctorH [id=23,name=John Doe,
    // type=pediatrician].
    // */
    ...
    //
    //
    // public abstract Criteria getChildrenCriteria(Session session, HibernateBackupSelectableObject
    // object);
