 ...
 */
public class I18nControlDbT extends I18nControlAbstract
{
    ...
    static private I18nControlDbT m_i18n = null; // This is handle to unique
                                                 // singelton instance
     ...
     * 
     */
    static public I18nControlDbT getInstance()
    {
        if (m_i18n == null)
        {
            m_i18n = new I18nControlDbT();
        }
        return m_i18n;
    }
     ...
     * );
     * s_logger.warn(
     * "Configuration file not found. Using default langauge ('en')"
     * );
     * }
     */
    // }
    ...
    {
        return "../data/DbTool_Config.properties";
    }
