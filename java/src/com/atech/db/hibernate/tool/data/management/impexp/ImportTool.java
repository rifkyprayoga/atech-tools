...
public abstract class ImportTool extends ImportExportAbstract
{
     ...
     *
     * @param cfg the cfg
     * @param context ImportExportContext
     */
    public ImportTool(Configuration cfg, ImportExportContext context, RestoreFileInfo restoreFileInfo)
    {
        super(cfg, context);
        setRestoreFileInfo(restoreFileInfo);
    }
     ...
     * Instantiates a new export tool.
     *
     * @param hibernateConfiguration the hib_conf
     */
    public ImportTool(HibernateConfiguration hibernateConfiguration, ImportExportContext importExportContext,
