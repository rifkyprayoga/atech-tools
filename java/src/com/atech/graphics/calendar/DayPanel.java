...
public class DayPanel extends JPanel implements CalendarListener
{
    ...
    // private int month_days[] = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30,
    // 31 };
    ...
    public DayPanel(CalendarModel cMod, ATDataAccessAbstract da)
    {
        ...
        String days[] = { m_ic.getMessage("SU"), m_ic.getMessage("MO"), m_ic.getMessage("TU"), m_ic.getMessage("WE"),
                         m_ic.getMessage("TH"), m_ic.getMessage("FR"), m_ic.getMessage("SA") };
    ...
    private void doLayoutButtons()
    {
        ...
        // System.out.println("year: " + cMod.getYear() + " first: " + firstday
        // + " num_days: " + numdays + ", num_days_m: " + numdays_m +
        // ", curr_day=" + curday);

        int entries = numdays_m + firstday;

        if (entries > 35)
        // (((numdays_m==31) && (firstday>4)) || ((numdays_m==30) &&
        // (firstday>5)))
        {
        ...
        // (((numdays_m==28) && (firstday==0)) || ((numdays_m==28) &&
        // (firstday==1)) )
        {
        ...
        // (((numdays_m==29) && (firstday==0)) || ((numdays_m==28) &&
        // (firstday==1)))
        {
        ...
        for (int i = 1; i <= numdays_m; i++)
        {
            ...
            if (i == current_day)
            {
                ...
                b.setFont(this.font_bold); // new Font("Dialog", Font.BOLD,
                                           // 12));
            }
        }
