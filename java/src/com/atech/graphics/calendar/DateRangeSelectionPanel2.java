...
public class DateRangeSelectionPanel2 extends JPanel implements ItemListener, /*ChangeListener,*/ ActionListener   //ChangeListener
{
    ...
    private DateRangeSelectionPanel2(ATDataAccessAbstract da, GregorianCalendar endDate, GregorianCalendar startDate, int range)
    {
    	super();
        m_da = da;
...
//        setRange(range);
    ...
    private void init()
    {
        ...
        ATSwingUtils.getLabel(this.m_ic.getMessage("DATE_TILL") + ":", 10, 48, 120, 25, this, ATSwingUtils.FONT_NORMAL_BOLD);
        ...
        ATSwingUtils.getLabel(this.m_ic.getMessage("DATE_FROM")+ ":", 10, 95, 120, 25, this, ATSwingUtils.FONT_NORMAL_BOLD);
...
//        this.dt_from.addChangeListener(this);
    ...
    public void setRange(int range)
    {
        ...
        //this.dt_from.setEnabled(this.current_range == DateRangeData.RANGE_CUSTOM);
    }
...
//            this.setRange(this.current_range);
    ...
    {
        /*
        //System.out.println("setChanged(current=" + this.current_range + ",range=" + range);
