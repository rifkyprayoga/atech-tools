 ...
 * ZeroLayout, must also have type (constraint) set. see ZeroLayoutType.
 * <p>
 *
 * <p>
...
public class ZeroLayout2 implements LayoutManager, Serializable
{
     ...
     */
    Hashtable<AccessibleContext, ZeroElement2> components = new Hashtable<AccessibleContext, ZeroElement2>();
     ...
     */
    public ZeroLayout2(int width, int height)
    {
        this.width = width;
        this.height = height;
    }
     ...
     */
    public ZeroLayout2(Dimension dim)
    {
    ...
    public void addLayoutComponent(String layoutType, Component comp)
    {
     ...
     *              constants.
     */
    public void addLayoutComponent(ZeroLayoutType layoutType, Component comp)
    {
        ...
        synchronized (comp.getTreeLock())
        {
            ...
            {
                ZeroElement2 ze = new ZeroElement2(comp.getBounds(), layoutType, getSize(), comp, this);
            ...
            // else
            // throw new
            // IllegalArgumentException("cannot add to layout: you must specify type of component");
        }
        comp.repaint();
    }
    ...
    {
        addLayoutComponent((ZeroLayoutType) hj, comp);
    }
     ...
     */
    private Rectangle recalculateComponent(Component parent, ZeroElement2 zer)
    {
        ...
        if (zer.type.isDynamic) // .startsWith("dynamic"))
        {

            // public static String DYNAMIC_SIZE = "dynamic_size";
            // public static String DYNAMIC_LOCATION = "dynamic_location";

            if (zer.type == ZeroLayoutType.Dynamic || zer.type == ZeroLayoutType.DynamicSize) // .equals("dynamic"))
            {
                rec.x = zer.posX;
                rec.y = zer.posY;
            }
            ...
            if (zer.type == ZeroLayoutType.DynamicLocation)
            {
        ...
        // if (!zer.type.isDynamic)) // .startsWith("static")
        {
...
class ZeroElement2
{
    ...
    private int positionXInProcentOfOriginal;
    private int positionYInProcentOfOriginal;
    /*
    ...
    ZeroLayoutType type = ZeroLayoutType.None;
     ...
     */
    ZeroElement2(Rectangle rec, ZeroLayoutType type, Dimension size, Component component, ZeroLayout2 layout)
    {
        this.posX = rec.x;
        this.posY = rec.y;
        ...
        positionXInProcentOfOriginal = posX / layout.width;
        positionYInProcentOfOriginal = posY / layout.height;
    ...
    public String toString()
    {
        if (type.equals("static"))
            ...
            return "ZeroElement(Dynamic)=[" + posX + "%, " + posY + "%, " + posWp + "%, " + posHp + "%,componentName="
                    + component.getName() + "]";
        else
