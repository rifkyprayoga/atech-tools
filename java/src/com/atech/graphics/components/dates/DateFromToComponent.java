...
public class DateFromToComponent extends JPanel implements /* ChangeListener, */ItemListener
{
     ...
     * @param ic
     */
    public DateFromToComponent(int lower_year, int higher_year_diff, ATDataAccessAbstract da, int orientation_,
            boolean prefefined_same_line_, int label_gap_, int component_gap_)
    {
        super();
    ...
    private void initComponentVertical(int lower_year, int higher_year_diff)
    {
        ...
        ATSwingUtils.getLabel(ic.getMessage("DTCMP_PREDEFINED") + ":", 5, 5, 110, 25, this,
            ATSwingUtils.FONT_NORMAL_BOLD);

        cmb_predefined = ATSwingUtils.getComboBox(getPredefinedFilterValues(), 105 + label_gap, 3, 205, 25, this,
            ATSwingUtils.FONT_NORMAL);
        cmb_predefined.addItemListener(this); // 5

        ATSwingUtils.getLabel(ic.getMessage("DTCMP_FROM") + ":", 5, 35 + component_gap, 100, 25, this,
            ATSwingUtils.FONT_NORMAL_BOLD);
        ...
        ATSwingUtils.getLabel(ic.getMessage("DTCMP_TILL") + ":", 5, 65 + 2 * component_gap, 150, 25, this,
            ATSwingUtils.FONT_NORMAL_BOLD);
    ...
    private void initComponentHorizontal(int lower_year, int higher_year_diff)
    {
        ...
        cmb_predefined = ATSwingUtils.getComboBox(getPredefinedFilterValues(), 103 + label_gap, 5, 205, 25, this,
            ATSwingUtils.FONT_NORMAL); // 105
                                                     ...
                                                     // e)
    {
        ...
        if (pred_item.equals(ic.getMessage("DTCMP_FILTER_TODAY")))
        {
            ...
            from = new GregorianCalendar(now.get(Calendar.YEAR), now.get(Calendar.MONTH),
     ...
     * {
     * this.getDate();
     * ActionEvent ae = new ActionEvent(this, (int) serialVersionUID,
     * this.action_command);
     * ae.setSource(this);
     * notifyListeners(ae);
     * }
