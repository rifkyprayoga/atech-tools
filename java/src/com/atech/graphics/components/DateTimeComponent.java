...
public class DateTimeComponent extends JPanel
{
    ...
    */
     ...
     * @param time_type the time_type
     */
    public DateTimeComponent(int lower_year, int higher_year_diff, ATDataAccessAbstract da, int type_align, int gap,
            int time_type)
    {
        super();
    ...
    */
    ...
    public static void main(String args[])
    {
        ...
        // System.out.println("Day: " + dt.substring(6,8) + " Month: " +
        // dt.substring(4,6) + " Year: " + dt.substring(0,4));
