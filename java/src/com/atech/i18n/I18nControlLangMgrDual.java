...
public class I18nControlLangMgrDual extends I18nControlLangMgr
{
    ...
    public String getMessageFromCatalogSelectedLanaguge(String msg)
    {
        ...
        if (debug_language)
            log.debug("getMessageFromCatalogSelLang: [root=" + this.i18ncontrol_runner.getLanguageFileRoot() + ", lang=" + this.getSelectedLanguage() + ", msg=" + msg + ", translation=" + retString);
        return retString;
    }
    ...
    public String getMessageFromCatalogDefaultLangauge(String msg)
    {
        ...
        if (debug_language)
            log.debug("getMessageFromCatalogDefLang: [root=" + this.primaryLang.getI18nControlRunner().getLanguageFileRoot() + ", lang=" + this.primaryLang.getSelectedLanguage() + ", msg=" + msg + ", translation=" + retString);
        return retString;
    }
    ...
    public synchronized String getMessageFromCatalog(String msg)
    {
        ...
        //log.debug("getMessageFromCatalog: [msg=" + msg + ",trasnlation=" + retString);
        ...
        if (retString.equals(msg))
        {
            ...
            //log.debug("getMessageFromCatalog: [msg=" + msg + ",trasnlation_def=" + retString);
