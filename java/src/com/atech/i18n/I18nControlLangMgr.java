...
public class I18nControlLangMgr extends I18nControlAbstract
{
     ...
     * {
     * System.out.println("Couldn't find resource file(1): " + lang_file_root +
     * "." + selected_language + ".properties");
     * try
     * {
     * res = ResourceBundle.getBundle(lang_file_root, new
     * Locale(this.def_language));
     * }
    ...
    public void setLanguage(LanguageInstance li)
    {
        ...
        // System.out.println("Trying to load: " + prefix + "" + lang_file_root
        // + ",lcl=" + lcl);
        try
        {
            ...
            {
                // System.out.println("Current Location: " + new
                // File(".").getAbsolutePath());

                // System.out.println("ResBundle: prefix=" + prefix +
                // ",LangFileRoot=" + lang_file_root );

                // FIXME Testing
                res = ResourceBundle.getBundle(prefix + "" + lang_file_root, lcl);
                // res = new PropertyResourceBundle(new FileInputStream(prefix +
                // "" + lang_file_root + li.name + ".properties"));

                /*
                 * try
                 * {
                 * res = ResourceBundle.getBundle(prefix + "" + lang_file_root,
                 * lcl);
                 * }
                 * catch(Exception ex1)
                 * {
            ...
            // System.out.println("Res: " + prefix + "" + lang_file_root +
            // ", Locale: " + lcl + "File:" + res.getString("I18NFILE"));
