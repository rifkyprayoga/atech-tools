...
public class TranslatorO extends TranslatorH implements BackupRestoreObject, DatabaseObjectHibernate
{
     ...
     * @param ch
     */
    public TranslatorO(TranslatorH ch)
    {
        this.setId(ch.getId());
        this.setUsername(ch.getUsername());
        this.setPassword(ch.getPassword());
        this.setSpecial_tag(ch.getSpecial_tag());
    }
     ...
     * @param ic
     */
    public TranslatorO(I18nControlAbstract ic)
    {
        this.ic = ic;
    }
    ...
    public String DbAdd(Session sess) throws Exception
    {
        ...
        TranslatorH ch = (TranslatorH) sess.get(TranslatorH.class, new Long(this.getId()));

        ch.setId(this.getId());
        ch.setUsername(this.getUsername());
        ch.setPassword(this.getPassword());
        ch.setSpecial_tag(this.getSpecial_tag());
