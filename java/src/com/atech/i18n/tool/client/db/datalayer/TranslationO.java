...
import com.atech.i18n.tool.client.db.hibernate.AppTranslationH;
...
public class TranslationO extends AppTranslationH implements BackupRestoreObject, DatabaseObjectHibernate
{
     ...
     * @param ch
     */
    public TranslationO(AppTranslationH ch)
    {
        this.setId(ch.getId());
        this.setApp_id(ch.getApp_id());
        this.setModule_id(ch.getModule_id());
        this.setLang_id(ch.getLang_id());
        this.setKeyword(ch.getKeyword());
     ...
     * @param ic
     */
    public TranslationO(I18nControlAbstract ic)
    {
        this.ic = ic;
    }
    ...
    public String DbAdd(Session sess) throws Exception
    {
        ...
        AppTranslationH ch = (AppTranslationH) sess.get(AppTranslationH.class, new Long(this.getId()));

        ch.setId(this.getId());
        ch.setApp_id(this.getApp_id());
        ch.setModule_id(this.getModule_id());
        ch.setLang_id(this.getLang_id());
        ch.setKeyword(this.getKeyword());
        ch.setValue(this.getValue());
        ch.setStatus(this.getStatus());
        ch.setChanged(this.getChanged());
