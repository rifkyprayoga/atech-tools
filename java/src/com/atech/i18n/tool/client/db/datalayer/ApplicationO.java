...
public class ApplicationO extends ApplicationH implements BackupRestoreObject, DatabaseObjectHibernate
{
     ...
     * @param ch
     */
    public ApplicationO(ApplicationH ch)
    {
        this.setId(ch.getId());
     ...
     * @param ic
     */
    public ApplicationO(I18nControlAbstract ic)
    {
        this.ic = ic;
    }
    ...
    public String DbAdd(Session sess) throws Exception
    {
        ...
        ApplicationH ch = (ApplicationH) sess.get(ApplicationH.class, new Long(this.getId()));
