...
public class LanguageO extends LanguageH implements BackupRestoreObject, DatabaseObjectHibernate
{
     ...
     * @param ic
     */
    public LanguageO(I18nControlAbstract ic)
    {
        this.ic = ic;
    }
    ...
    public String DbAdd(Session sess) throws Exception
    {
        ...
        LanguageH ch = (LanguageH) sess.get(LanguageH.class, new Long(this.getId()));
