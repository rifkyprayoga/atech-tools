...
public class AppGroupO extends AppGroupH implements BackupRestoreObject, DatabaseObjectHibernate
{
    ...
    ArrayList<TranslationO> list_type_1 = new ArrayList<TranslationO>();
   // ArrayList<TranslationSourceO> list_type_2 = new ArrayList<TranslationSourceO>();
     ...
     * @param ic
     */
    public AppGroupO(I18nControlAbstract ic)
    {
        this.ic = ic;
    }
    ...
    public String DbAdd(Session sess) throws Exception
    {
        ...
        AppGroupH ch = (AppGroupH) sess.get(AppGroupH.class, new Long(this.getId()));
    ...
    {
        return this.list_type_1.get(index);
    }
    ...
    {
        return this.list_type_1.indexOf(child);
    }
