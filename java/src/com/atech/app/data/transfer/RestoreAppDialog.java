...
public class RestoreAppDialog extends RestoreDialog
{
     ...
     * @param filename
     */
    public RestoreAppDialog(JDialog parent, ATDataAccessAbstract da, BackupRestoreCollection br_coll, String filename, AbstractApplicationContext aac)
    {
     ...
     * @param filename
     */
    public RestoreAppDialog(JFrame parent, ATDataAccessAbstract da, BackupRestoreCollection br_coll, String filename, AbstractApplicationContext aac)
    {
        super(parent, da, br_coll, filename);
        this.m_aac = aac;
    }
...
*/
    ...
    {
        BackupRestoreRunner brr = this.m_aac.getBackupRestoreRunner(AbstractApplicationContext.DB_ACTION_RESTORE); //this.restore_files, this, this.m_aac.getSpecialRestoreParameter());
        brr.start();
        
        //        MDOBackupRestoreRunner gbrr = new MDOBackupRestoreRunner(this.restore_files, this, "" + this.cb_daily.isSelected());
        //gbrr.start();
    }
