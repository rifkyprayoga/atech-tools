...
public class TimeRangesData
{
    ...
    public TimeRangesData(GregorianCalendar curr_gc, int[] rnge_selector, int dt_type, ATDataAccessAbstract da)
    {
        ...
        for (int element : range_selector)
        {
            this.data_procesor.put(element, getRange(element));
        }
    }
            ...
            case RANGE_PREV_MONTH:
                {
                    ...
                    // System.out.println("Month: From=" +
                    // ATechDate.getATDateTimeFromDateParts(1, m, y) + ", To=" +
                    // ATechDate.getATDateTimeFromDateParts(31, m, y));
