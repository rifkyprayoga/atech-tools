    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (app != null && app_ver != null)
        {
            ...
            if (!latest_ver)
            {
                ...
                out.println("<b>Is there newer version for our db?</b> " + (never_ver != -1) + " [" + never_ver + "]"
                        + "<br>");
        ...
        if (this.error_id == 0)
        {
            ...
            if (!latest_ver)
            {
                ...
                out.println("  <newer_version_higher_db_number>" + this.getLatestVersion(app).version_num
