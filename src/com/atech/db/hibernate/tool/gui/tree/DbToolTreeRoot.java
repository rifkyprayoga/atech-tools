...
public class DbToolTreeRoot
{
    ...
    * The m_app_list.
    */
    public ArrayList<DatabaseConfiguration> m_app_list = null;
    ...
    public DbToolApplicationInterface getCurrentDbToolApplicationInterface()
    {
        if (type == ROOT_SINGLE)
        {
            return this.m_app;
        ...
        else
        {
            throw new NotImplementedException(this.getClass(), //
                    "getCurrentDbToolApplicationInterface", "for Multiple Applications");
        }
    }
     ...
     */
    public ArrayList<DatabaseConfiguration> getListOfDatabases(DbToolApplicationInterface intr)
    {
        intr.loadConfig();
