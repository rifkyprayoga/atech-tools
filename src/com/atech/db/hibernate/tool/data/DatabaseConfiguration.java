...
public class DatabaseConfiguration implements Comparable<DatabaseConfiguration> // <DatabaseSettings>
{
     ...
     */
    public DatabaseConfiguration(String name, String driver, String url, String port, String dialect)
    {
        this.name = name;
        this.driver = driver;
        this.url = url;
     ...
     */
    public int compareTo(DatabaseConfiguration ds)
    {
